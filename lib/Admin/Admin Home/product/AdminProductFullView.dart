...
class AdminProductFullView extends StatefulWidget {
  ...
  @override
  _AdminProductFullViewState createState() => _AdminProductFullViewState();
}

class _AdminProductFullViewState extends State<AdminProductFullView> {
