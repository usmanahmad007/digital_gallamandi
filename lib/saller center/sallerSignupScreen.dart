...
class sallerSignupscreen extends StatefulWidget {
  const sallerSignupscreen({super.key});

  @override
  State<sallerSignupscreen> createState() => _sallerSignupscreenState();
}

class _sallerSignupscreenState extends State<sallerSignupscreen> {
      ...
      try {
        ...
        if (user != null) {
          try {
            ...
            _showFloatingSnackBar('Signup successful!', Colors.green);
