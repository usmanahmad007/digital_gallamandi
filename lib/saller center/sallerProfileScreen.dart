...
import 'package:zrai_mart/saller%20center/sallerEditProfileScreen.dart';

import 'sallerCustomGestureDetector.dart';
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => sallerEditProfileScreen()),
                );
              },
