...
class _AddproductState extends State<Addproduct> {
  ...
  Future<void> _loadCategories() async {
    ...
    setState(() {
      ...
      if (_selectedCategory == null || !_categoryDropdownItems.any((item) => item.value == _selectedCategory)) {
        _categoryDropdownItems.add("Rental" as DropdownMenuItem<String>);
 ...
 /* Future<void> getImage(bool isCamera) async {
  ...
  Future<void> getImage(bool isCamera) async {
    if (_images.length >= 3) {
      _showSnackbar('You can upload up to 3 images only', Colors.red);
      return;
    }
  ...
  void _uploadProduct() async {
    ...
    if (_isRental==false && _selectedCategory == null) {
  ...
  Widget _buildDropdownField() {
    return DropdownButtonFormField<String>(
      ...
      style: const TextStyle(color: Colors.black), // Text color of the selected item
  ...
  Widget _buildPriceField() {
    return TextFormField(
      ...
      keyboardType: TextInputType.number,
      decoration: InputDecoration(
        labelText: _isRental?"Rent/hr":'Price',
