...
import 'package:zrai_mart/saller%20center/sallerProductFullView.dart';
...
class _sallerProductScreenState extends State<sallerProductScreen> {
  ...
  Future<void> fetchDataFromFirebase() async {
    try {
      ...
      CollectionReference collectionRef = FirebaseFirestore.instance.collection('slider');
      QuerySnapshot querySnapshot = await collectionRef.get();

      setState(() {
        imageSliders = querySnapshot.docs.map((doc) => doc['image1'] as String).toList();
      });
    } catch (e) {
